...
> = {
  ...
  lodash: {
    ...
    reason:
      'Standard lodash is CommonJS and hard to tree-shake. lodash-es is the ESM version',
  },
  axios: {
    replacement: 'native fetch',
    reason:
      'Axios adds ~11KB gzipped, Native fetch is built into modern browsers and Node18+',
  },
  request: {
    replacement: 'got',
