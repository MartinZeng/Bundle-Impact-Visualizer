...
//       console.log(
//   `${picocolors.magenta('Name')}${picocolors.cyan(':')} ${picocolors.blue(pkg.name)}`
// );

//       console.log(`${picocolors.white('--------------------------------')}\n`);
//       console.log(
//   `${picocolors.magenta('Version')}${picocolors.cyan(':')}  ${picocolors.blue(pkg.version)}`
// );
...
//     const bar = picocolors.magenta('█'.repeat(barLength));
...
//  const labelWidth = 8;
//  const barWidth = 40; // fixed width for consistent rendering
//  const countWidth = 12;
...
//    const filledBar = picocolors.green('█'.repeat(filledLength));
...
//  console.log(picocolors.white('++++++++++++++++++++++++++++++++++++++++'));
//  console.log(
//    picocolors.white(`Total packages analyzed: ${total}\n`)
//  );
// }
...
//        // Size distribution chart
//        console.log(`\n${picocolors.cyan('📊 Package Size Distribution:')}`);
//        const distribution = generateSizeDistribution(packageSizes);
//         renderStyledChart(distribution);
...
console.log(`${label} ${filledBar}${emptyBar} ${percentText}`);
 ...
 console.log(picocolors.gray('...............................'));
 console.log(
   picocolors.magenta(`Total packages analyzed: ${total}\n`)
 );
}
